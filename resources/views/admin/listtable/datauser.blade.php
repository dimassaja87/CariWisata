...
<head>
    ...
    <!-- Sweet Alert css-->
    <link href="{{ asset('admin/themesbrand.com/velzon/html/default/assets/libs/sweetalert2/sweetalert2.min.css') }}" rel="stylesheet" type="text/css" />
...
<div id="removeNotificationModal" class="modal fade zoomIn" tabindex="-1" aria-hidden="true">
            ...
            <div id="scrollbar">
                <div class="container-fluid">
                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="/adminn" role="button" aria-expanded="false" aria-controls="sidebarDashboards">
                                        ...
                                        <div class="table-responsive table-card mt-3 mb-1">
                                            <table class="table align-middle table-nowrap" id="customerTable">
                                                <thead class="table-light">
                                                    <tr>
                                                        ...
                                                        <th class="sort" data-sort="customer_name">Nama User</th>
                                                        <th class="sort" data-sort="email">Email User</th>
                                                        <th class="sort" data-sort="foto">Foto Profil</th>
                                                        <th class="sort" data-sort="tanggal">Tanggal Bergabung</th>
                                            ...
                                            <div class="noresult" style="display: none">
                                                <div class="text-center">
                                                    ...
                                                    <p class="text-muted mb-0">Kami telah mencari lebih dari 99+ Pengguna, Kami tidak menemukan data apa pun yang Anda cari.</p>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <form action="/insertpengguna" method="POST" enctype="multipart/form-data" class="tablelist-form">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" id="customername-field" name="nama" class="form-control" placeholder="Enter Name" required />
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="file" id="date-field" name="foto" class="form-control" placeholder="Select Photo" required />
    ...
    <script src="{{ asset('admin/themesbrand.com/velzon/html/default/assets/libs/list.pagination.js/list.pagination.min.js') }}"></script>

    <!-- listjs init -->
    <script src="{{ asset('admin/themesbrand.com/velzon/html/default/assets/js/pages/listjs.init.js') }}"></script>

    <!-- Sweet Alerts js -->
    <script src="{{ asset('admin/themesbrand.com/velzon/html/default/assets/libs/sweetalert2/sweetalert2.min.js') }}"></script>
