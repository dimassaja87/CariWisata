                            ...
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                ...
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">Data Ulasan</a></li>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="card-title mb-0">Edit Data Ulasan</h5>

                                </div>
                                <div class="card-body">
                                    <form action="{{ route('updateulasan', $data->id) }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <div class="mb-3">
                                            <label for="customername-field" class="form-label">Nama
                                                User</label>
                                            <input type="text" id="customername-field" name="nama"
                                                class="form-control" placeholder="Masukkan nama" value="{{ $data->nama }}" required />
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <br><img class="img mb-3"src="{{ asset('fotowisata/' . $data->foto) }}"
                                        ...
                                        <div class="mb-3">
                                            <label for="email-field" class="form-label">Komentar</label>
                                                <input class="form-control" name="pesan" placeholder="Masukkan komentar" id="floatingTextarea" value="{{ $data->pesan }}" required/>
