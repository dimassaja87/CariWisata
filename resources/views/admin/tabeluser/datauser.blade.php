                                    ...
                                    <div id="customerList">
                                        <div class="row g-4 mb-3">
                                            <div class="col-sm-auto">
                                                <div>
                                                    <a href="/tambahpengguna" type="button" class="btn btn-success add-btn" id="create-btn"><i class="ri-add-line align-bottom me-1"></i> Add</a>
                                            ...
                                            <table class="table align-middle table-nowrap" id="customerTable">
                                                ...
                                                <tbody class="list form-check-all">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="foto">
                                                            <img src="{{ asset('fotopengguna/' . $row->foto) }}" alt="" width="150">
                                                        </td>
                                                        <td class="tanggal">{{ $row->created_at->format('d M, Y') }}</td>
                                                        <td>
                                                            <div class="d-flex gap-2">
                                                                <div class="edit">
                                                                    <a href="/tampilpengguna/{{ $row->id }}" class="btn btn-sm btn-success edit-item-btn">Edit</a>
                                                                </div>
                                                                <div class="remove">
                                                                    <a href="/deletepengguna/{{ $row->id }}" class="btn btn-sm btn-danger remove-item-btn">Remove</a>
                                                                </div>
                                                            </div>
                                                        </td>
                                                    </tr>
