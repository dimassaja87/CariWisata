...
<body>
	...
	<div id="wrapper" class="wrapper">
		<div class="fxt-template-animation fxt-template-layout5">
			<div class="fxt-bg-img fxt-none-767" data-bg-image="https://i.pinimg.com/originals/49/53/62/495362d6ccfe3a389eeb7cadf74ab3ac.jpg">
				<div class="fxt-intro">
					<div class="sub-title">Selamat Datang di</div>
					<h1>Cari Wisata</h1>
					<p>Login dan temukan yang menarik dengan Web Cari Wisata lebih mudah.</p>
				</div>
			</div>
				...
				<div class="fxt-form">
					<form method="POST">
						...
						<div class="form-group fxt-transformY-50 fxt-transition-delay-2">
							...
							{{-- <a href="forgot-password-5.html" class="switcher-text3">Lupa Password?</a> --}}
						</div>
						<div class="form-group fxt-transformY-50 fxt-transition-delay-3">
							<div class="fxt-content-between">
								...
								<div class="checkbox">
									...
									<label for="checkbox1">Ijinkan saya tetap masuk</label>
								</div>
							</div>
						</div>
					</form>
