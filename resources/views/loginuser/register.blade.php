		...
		<div class="fxt-template-animation fxt-template-layout5">
			<div class="fxt-bg-img fxt-none-767" data-bg-image="https://i.pinimg.com/originals/49/53/62/495362d6ccfe3a389eeb7cadf74ab3ac.jpg">
				<div class="fxt-intro">
					...
					<h1>Cari Wisata</h1>
					<p>Silahkan Registrasi jika kamu belum memiliki akun untuk login dan Temukan yang menarik dengan Web Cari Wisata lebih mudah.</p>
				</div>
			</div>
						...
						<div class="form-group fxt-transformY-50 fxt-transition-delay-4">
							<div class="fxt-content-between">
								...
								<div class="checkbox">
									...
									<label for="checkbox1">Saya menyetujui persyaratan</label>
								</div>
							</div>
						</div>
					</form>
