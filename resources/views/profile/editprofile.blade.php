...
<!-- /.modal -->
                ...
                <div class="container-fluid">
                    ...
                    <div class="position-relative mx-n4 mt-n4">
                        <div class="profile-wid-bg profile-setting-img">
                            <img src="{{ asset('admin/themesbrand.com/velzon/html/default/assets/images/profile-bg.jpg') }}" class="profile-wid-img" alt="">
                            ...
                            <div class="card mt-n5">
                                <div class="card-body p-4">
                                    <div class="text-center">
                                        <form method="post" action="/updateprofil/{{Auth::user()->id}}" enctype="multipart/form-data">
                                            @method('put')
                                            @csrf
    ...
    <script src="{{ asset('admin/themesbrand.com/velzon/html/default/assets/js/pages/profile-setting.init.js') }}"></script>
