                                    ...
                                    <li class="nav-item">
                                        ...
                                        <div class="collapse menu-dropdown" id="sidebarProjects">
                                            <ul class="nav nav-sm flex-column">
                                                ...
                                                <li class="nav-item">
                                                    <a href="apps-projects-overview.html" class="nav-link" data-key="t-overview"> Statistik </a>
                                                </li>
                                                <li class="nav-item">
                                                ...
                                                <li class="nav-item">
                                                    ...
                                                    <div class="collapse menu-dropdown" id="sidebarJoblists">
                                                        <ul class="nav nav-sm flex-column">
                                                            ...
                                                            <li class="nav-item">
                                                                <a href="apps-job-details.html" class="nav-link" data-key="t-overview"> Statistik </a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </li>
...
=======
                                            <p class="fs-14 mb-0">Wisata</p>
>>>>>>> e2cef0bf541503bcc37faaae4ac7144a27767b10
>>>>>>> Stashed changes
                                        </div>
                                    </div>
                                </div>
...
=======
<<<<<<< HEAD
                                                <i class="ri-airplay-fill d-inline-block d-md-none"></i> <span class="d-none d-md-inline-block">Grafik</span>
=======
                                                <i class="ri-airplay-fill d-inline-block d-md-none"></i> <span class="d-none d-md-inline-block">Statistik</span>
>>>>>>> e2cef0bf541503bcc37faaae4ac7144a27767b10
>>>>>>> Stashed changes
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="d-flex align-items-center mb-4">
                                                    <h5 class="card-title flex-grow-1 mb-0">Komentar</h5>
                                                    <div class="flex-shrink-0">
