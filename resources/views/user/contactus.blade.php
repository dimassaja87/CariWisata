...
<!-- Mirrored from templates.hibootstrap.com/jaunt/default/contact.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 23 Feb 2023 13:22:01 GMT -->
<head>
<meta charset="UTF-8" />
...
<a href="https://templates.hibootstrap.com/cdn-cgi/l/email-protection#58303d3434371832392d362c763b3735"><span class="__cf_email__" data-cfemail="8ee6ebe2e2e1cee4effbe0faa0ede1e3">[email&#160;protected]</span></a>
</div>
<div class="content">
<i class='bx bx-map'></i>
...
<div class="bg-image">
<img src="{{ asset('user/templates.hibootstrap.com/jaunt/default/assets/img/page-title-area/contact.jpg') }}" alt="Demo Image">
</div>
</div>
...
<form id="contactForm">
<h3 class="sub-title">Hubungi Kami</h3>
<div class="row">
<div class="col-md-12">
<div class="form-group">
<div class="input-icon"><i class='bx bx-user'></i></div>
<input type="text" name="name" class="form-control" id="name" required="" data-error="Please enter your name" placeholder="Nama" />
...
<input type="text" name="subject" class="form-control" id="subject" required="" data-error="Please enter subject" placeholder="Subjek" />
<div class="help-block with-errors"></div>
</div>
</div>
<div class="col-md-12">
...
<textarea name="message" id="message" class="form-control" cols="100" rows="6" required="" data-error="Please enter your message" placeholder="Pesan..."></textarea>
<div class="help-block with-errors"></div>
</div>
</div>
<div class="col-md-12">
...
<label class="form-check-label" for="gridCheck">
    Terima<a href="terms-condition.html">Syarat & Ketentuan</a> Dan <a href="privacy-policy.html">Kebijakan Privasi.</a>
</label>
<div class="help-block with-errors"></div>
</div>
</div>
...
<h3 class="sub-title">Kantor Banyuwangi</h3>
<div class="content-list">
<i class='bx bx-map'></i>
<h6>Jalan raya genteng, Banyuwangi</h6>
</div>
<div class="content-list">
<i class='bx bx-phone'></i>
<h6>Telepon: +6283 4612 4836</h6>
</div>
<div class="content-list">
<i class='bx bx-receipt'></i>
<h6>Fax: +6281 2368 0983</h6>
</div>
<div class="content-list">
<i class='bx bx-at'></i>
<h6>Email: <a href="https://templates.hibootstrap.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="a9c3c8dcc7dde9c0c7cfc687cac6c4">[email&#160;protected]</a></h6>
</div>
</div>
<div class="info-content">
<h3 class="sub-title">Kantor Malang</h3>
<div class="content-list">
<i class='bx bx-map'></i>
<h6>Perum Regerency, GPA, malang</h6>
</div>
<div class="content-list">
<i class='bx bx-phone'></i>
<h6>Telepon: +6285 5737 2934</h6>
</div>
<div class="content-list">
<i class='bx bx-receipt'></i>
<h6>Fax: +6281 3746 9274</h6>
</div>
<div class="content-list">
<i class='bx bx-at'></i>
<h6>Email: <a href="https://templates.hibootstrap.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="7e141f0b100a3e17101811501d1113">[email&#160;protected]</a></h6>
</div>
</div>
</div>
</div>
