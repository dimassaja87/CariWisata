                                                ...
                                                <div class="mg_hotel_destination fancy-overlay">
                                                    ...
                                                    <div class="text">
                                                        <div class="mg_destination_hd">
                                                            <h5><a href="/peuncang">Pantai Peuncang Banten</a></h5>
                                                        </div>
                                                        <div class="mg_destination_review">
                                                            <p>Wisata Banten di Pantai Peuncang cocok untuk Anda yang ingin berlibur akhir pekan sejenak dari hiruk-piruk kehidupan di kota.</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
