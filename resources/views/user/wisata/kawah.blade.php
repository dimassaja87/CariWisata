                                    ...
                                    <div class="mg_blog_full">
                                        ...
                                        <br><h5 class="blog_main_title">Harga Tiket Masuk</h5></br>
                                            <div class="mg_table">
                                                ...
                                                <ul>
                                                    <li>Wisatawan Domestik</li>
                                                    <li>Rp28.000</li>
                                                </ul>
                                                <ul>
                                                    <li>Wisatawan Mancanegara</li>
                                                    <li>Rp81.000</li>
                                                </ul>
                                                <ul>
                                                    <li>Tiket Masuk Terusan Wisatawan Domestik</li>
                                                    <li>Rp40.000</li>
                                                </ul>
                                                <ul>
                                                    <li>Tiket Masuk Domestik + Ontang Anting PP</li>
                                                    <li>Rp57.000</li>
                                                </ul>
                                                <ul>
                                                    <li>Tiket Masuk Wisatawan Mancanegara + Ontang Anting PP</li>
                                                    <li>Rp110.000</li>
                                                </ul>
                                                <ul>
                                                    <li>Tiket Masuk Terusan Domestik + Ontang Anting PP</li>
                                                    <li>Rp69.000</li>
                                                </ul>
                                                <ul>
                                                    <li>Jasa Lingkungan (Parkir R4 di Pusat Kawah)</li>
                                                    <li>Rp162.000</li>
                                                </ul>
                                            </div>
                                            <br><h5>Fasilitas</h5></br>
                                            <p>Kawasan wisata Kawah Putih Ciwidey juga telah dilengkapi berbagai fasilitas yang memadai bagi wisatawan. Area pelataran parkirnya luas dan aman. Bagi yang ingin bersantap, telah tersedia banyak pilihan kios makan.</p>
