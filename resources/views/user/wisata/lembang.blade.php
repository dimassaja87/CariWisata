                                    ...
                                    <div class="mg_blog_full">
                                        ...
                                        <br><h5 class="blog_main_title">Harga Tiket Masuk Wahana dan Fasilitas</h5></br>
                                            <div class="mg_table">
                                                ...
                                                <ul>
                                                    <li>Storyland </li>
                                                    <li>Rp. 10.000-20.000</li>
                                                </ul>
                                                <ul>
                                                    <li>Naik Perahu</li>
                                                    <li>Rp. 20.000/20 menit</li>
                                                </ul>
                                                <ul>
                                                    <li>E Scooter</li>
                                                    <li>Rp. 120.000/jam</li>
                                                </ul>
                                            </div>
                                            <p>Note: harga tiket masuk Lembang Park and Zoo beserta wahana dan fasilitasnya di atas tidak selalu akurat, bisa berubah sewaktu-waktu. Untuk update harga dan informasi terbaru mengenai tempat wisata ini, Anda bisa akses instagram resminya, di @lembang_parkzoo</p>
                                            <br><h5>Fasilitas</h5></br>
                                            <p>Anak-anak Anda dijamin betah berliburan di Lembang Park Zoo Bandung. Pasalnya, objek wisata ini menyediakan banyak sekali atraksi dan wahana untuk mereka. Terutama di zona Storyland, tempat aneka permainan menarik untuk anak-anak. Bisa juga berperahu keliling danau buatan atau mengelilingi kawasan naik kereta mini.</p>
