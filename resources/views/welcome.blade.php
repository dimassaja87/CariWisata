            ...
            <div class="d-flex">
                ...
                <div class="navbar-brand-box horizontal-logo">
                    <a href="index.html" class="logo logo-dark">
                        ...
                        <span class="logo-lg">
                            <img src="{{ asset('admin/themesbrand.com/velzon/html/default/assets/images/logo-sm.png') }}" alt="" height="17">
                        </span>
                    </a>
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <span class="d-flex align-items-center">
                            <img class="rounded-circle header-profile-user" src="https://th.bing.com/th/id/OIP.va8TQkhgHcB0OWHjlAkqegHaE7?pid=ImgDet&w=2429&h=1619&rs=1" alt="Header Avatar">
                            <span class="text-start ms-xl-2">
                                <span class="d-none d-xl-inline-block ms-1 fw-medium user-name-text">Admin Web</span>
                                            ...
                                            <div class="card-body">
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-grow-1 overflow-hidden">
                                                        <p class="text-uppercase fw-medium text-muted text-truncate mb-0"> Total Wisata</p>
                                                    </div>

                                                </div>
                                                <div class="d-flex align-items-end justify-content-between mt-4">
                                                    <div>
                                                        <h4 class="fs-22 fw-semibold ff-secondary mb-4"><span class="counter-value" data-target="999">0</span></h4>
                                                    </div>
                                    ...
                                    <div class="col-xl-3 col-md-6">
                                        ...
                                        <div class="card card-animate">
                                            <div class="card-body">
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-grow-1 overflow-hidden">
                                                        <p class="text-uppercase fw-medium text-muted text-truncate mb-0">Komentar</p>
                                                    </div>
                                                ...
                                                <div class="row g-0 text-center">
                                                    <div class="col-6 col-sm-3">
                                                        <div class="p-3 border border-dashed border-start-0">
                                                            <h5 class="mb-1"><span class="counter-value" data-target="999">0</span></h5>
                                                        ...
                                                        <tbody>
                                                                ...
                                                                <td>
                                                                    <div class="d-flex align-items-center">
                                                                        <div class="avatar-sm bg-light rounded p-1 me-2">
                                                                            <img src="{{ asset('admin/themesbrand.com/velzon/html/default/assets') }}/images/products/img-1.png" alt="" class="img-fluid d-block" />
                                                                        </div>
                                                                        <div>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <div class="d-flex align-items-center">
                                                                        <div class="avatar-sm bg-light rounded p-1 me-2">
                                                                            <img src="{{ asset('admin/themesbrand.com/velzon/html/default/assets') }}/images/products/img-2.png" alt="" class="img-fluid d-block" />
                                                                        </div>
                                                                        <div>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <div class="d-flex align-items-center">
                                                                        <div class="avatar-sm bg-light rounded p-1 me-2">
                                                                            <img src="{{ asset('admin/themesbrand.com/velzon/html/default/assets') }}/images/products/img-3.png" alt="" class="img-fluid d-block" />
                                                                        </div>
                                                                        <div>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <div class="d-flex align-items-center">
                                                                        <div class="avatar-sm bg-light rounded p-1 me-2">
                                                                            <img src="{{ asset('admin/themesbrand.com/velzon/html/default/assets') }}/images/products/img-4.png" alt="" class="img-fluid d-block" />
                                                                        </div>
                                                                        <div>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <div class="d-flex align-items-center">
                                                                        <div class="avatar-sm bg-light rounded p-1 me-2">
                                                                            <img src="{{ asset('admin/themesbrand.com/velzon/html/default/assets') }}/images/products/img-5.png" alt="" class="img-fluid d-block" />
                                                                        </div>
                                                                        <div>
                                                        ...
                                                        <tbody>
                                                                ...
                                                                <td>
                                                                    <div class="d-flex align-items-center">
                                                                        <div class="flex-shrink-0 me-2">
                                                                            <img src="{{ asset('admin/themesbrand.com/velzon/html/default/assets') }}/images/companies/img-1.png" alt="" class="avatar-sm p-2" />
                                                                        </div>
                                                                        <div>
                                                            ...
                                                            <!-- <tr>
                                                                <td>
                                                                    <div class="d-flex align-items-center">
                                                                        <div class="flex-shrink-0 me-2">
                                                                            <img src="{{ asset('admin/themesbrand.com/velzon/html/default/assets') }}/images/companies/img-2.png" alt="" class="avatar-sm p-2" />
                                                                        </div>
                                                                        <div class="flex-grow-1">
                                                            ...
                                                            <!-- <tr>
                                                                <td>
                                                                    <div class="d-flex align-items-center">
                                                                        <div class="flex-shrink-0 me-2">
                                                                            <img src="{{ asset('admin/themesbrand.com/velzon/html/default/assets') }}/images/companies/img-3.png" alt="" class="avatar-sm p-2" />
                                                                        </div>
                                                            ...
                                                            <!-- <tr>
                                                                <td>
                                                                    <div class="d-flex align-items-center">
                                                                        <div class="flex-shrink-0 me-2">
                                                                            <img src="{{ asset('admin/themesbrand.com/velzon/html/default/assets') }}/images/companies/img-8.png" alt="" class="avatar-sm p-2" />
                                                                        </div>
                                                                        <div class="flex-grow-1">
                                                            ...
                                                            <!-- <tr>
                                                                <td>
                                                                    <div class="d-flex align-items-center">
                                                                        <div class="flex-shrink-0 me-2">
                                                                            <img src="{{ asset('admin/themesbrand.com/velzon/html/default/assets') }}/images/companies/img-5.png" alt="" class="avatar-sm p-2" />
                                                                        </div>
                                                                        <div class="flex-grow-1">
                                                                            <h5 class="fs-14 my-1 fw-medium">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div class="d-flex align-items-center">
                                                                        <div class="flex-shrink-0 me-2">
                                                                            <img src="{{ asset('admin/themesbrand.com/velzon/html/default/assets') }}/images/users/avatar-1.jpg" alt="" class="avatar-xs rounded-circle" />
                                                                        </div>
                                                            ...
                                                            <!-- <tr>
                                                                ...
                                                                <td>
                                                                    <div class="d-flex align-items-center">
                                                                        <div class="flex-shrink-0 me-2">
                                                                            <img src="{{ asset('admin/themesbrand.com/velzon/html/default/assets') }}/images/users/avatar-4.jpg" alt="" class="avatar-xs rounded-circle" />
                                                                        </div>
                                    ...
                                    <div class="card-body p-0">
                                        ...
                                        <!-- <div data-simplebar style="max-height: 410px;" class="p-3 pt-0">
                                            <div class="acitivity-timeline acitivity-main">
                                                    ...
                                                    <div class="flex-grow-1 ms-3">
                                                        ...
                                                        <div class="d-inline-flex gap-2 border border-dashed p-2 mb-2">
                                                            <a href="apps-ecommerce-product-details.html" class="bg-light rounded p-1">
                                                                <img src="{{ asset('admin/themesbrand.com/velzon/html/default/assets') }}/images/products/img-8.png" alt="" class="img-fluid d-block" />
                                                            </a>
                                                            <a href="apps-ecommerce-product-details.html" class="bg-light rounded p-1">
                                                                <img src="{{ asset('admin/themesbrand.com/velzon/html/default/assets') }}/images/products/img-2.png" alt="" class="img-fluid d-block" />
                                                            </a>
                                                            <a href="apps-ecommerce-product-details.html" class="bg-light rounded p-1">
                                                                <img src="{{ asset('admin/themesbrand.com/velzon/html/default/assets') }}/images/products/img-10.png" alt="" class="img-fluid d-block" />
                                                            </a>
                                                        </div>
                                                ...
                                                <div class="acitivity-item d-flex">
                                                    <div class="flex-shrink-0">
                                                        <img src="{{ asset('admin/themesbrand.com/velzon/html/default/assets') }}/images/users/avatar-3.jpg" alt="" class="avatar-xs rounded-circle acitivity-avatar" />
                                                    </div>
                                                    <div class="flex-grow-1 ms-3">
                                                                ...
                                                                <div class="d-flex">
                                                                    <div class="flex-shrink-0 avatar-sm">
                                                                        <div class="avatar-title bg-light rounded">
                                                                            <img src="{{ asset('admin/themesbrand.com/velzon/html/default/assets/images/companies/img-1.png') }}" alt="" height="30">
                                                                        </div>
                                                                    </div>
                                                                    <div class="flex-grow-1 ms-3">
                                                                        <div>
                                                    ...
                                                    <div class="swiper-slide">
                                                        <div class="card border border-dashed shadow-none">
                                                            <div class="card-body">
                                                                <div class="d-flex">
                                                                    <div class="flex-shrink-0">
                                                                        <img src="{{ asset('admin/themesbrand.com/velzon/html/default/assets/images/users/avatar-3.jpg') }}" alt="" class="avatar-sm rounded">
                                                                    </div>
                                                                    <div class="flex-grow-1 ms-3">
                                                                        <div>
                                                        ...
                                                        <div class="card border border-dashed shadow-none">
                                                            <div class="card-body">
                                                                <div class="d-flex">
                                                                    <div class="flex-shrink-0 avatar-sm">
                                                                        <div class="avatar-title bg-light rounded">
                                                                            <img src="{{ asset('admin/themesbrand.com/velzon/html/default/assets/images/companies/img-8.png') }}" alt="" height="30">
                                                                        </div>
                                                                    </div>
                                                                    <div class="flex-grow-1 ms-3">
                                                                        <div>
                                                    ...
                                                    <div class="swiper-slide">
                                                        <div class="card border border-dashed shadow-none">
                                                            <div class="card-body">
                                                                <div class="d-flex">
                                                                    <div class="flex-shrink-0">
                                                                        <img src="{{ asset('admin/themesbrand.com/velzon/html/default/assets/images/users/avatar-2.jpg') }}" alt="" class="avatar-sm rounded">
                                                                    </div>
                                                                    <div class="flex-grow-1 ms-3">
                                                                        <div>
